...
<svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="https://www.w3.org/2000/svg">
	<g id="style=linear">
		<g id="location">
			<path
				id="vector"
				...
				stroke={color}
				stroke-width="1.5" />
			<circle id="ellipse" cx="12" cy="9.5" r="2.5" stroke={color} stroke-width="1.5" />
		</g>
	</g>
</svg>
